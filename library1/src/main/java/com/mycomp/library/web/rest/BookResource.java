...
/**
 * REST controller for managing {@link com.mycomp.library.domain.Book}.
 */
@RestController
@RequestMapping("/api")
public class BookResource {
     ...
     */
    @GetMapping("/books")
    public ResponseEntity<List<BookDTO>> getAllBooks(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
